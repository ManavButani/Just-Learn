...
class MapQuest:
    ...
    def get_reverse(self):
        ...
        try:
            # print(g.json())
            print(g.json()["results"][0]["locations"][0]["adminArea1"],",",g.json()["results"][0]["locations"][0]["adminArea4"],",",g.json()["results"][0]["locations"][0]["adminArea6"],",",g.json()["results"][0]["locations"][0]["adminArea5"])
